...
public class API {
    ...
    protected static String[] parseToken(String response, boolean isVOD){
        ...
        //Parse JSON. Return null if no access token is available
        //(e.g. the VOD/stream does not exist or is unavailable).
        ...
        if(tokenCat.isNull(tokenKey)){
            return null;
        }
        tokenCat=tokenCat.getJSONObject(tokenKey);
